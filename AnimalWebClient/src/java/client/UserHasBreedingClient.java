...
public class UserHasBreedingClient {
    ...
    public <T> T findUserIdByEarTag_XML(Class<T> responseType, String earTag) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findUserIdByEarTag/{0}", new Object[]{earTag}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findUserIdByEarTag_JSON(Class<T> responseType, String earTag) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findUserIdByEarTag/{0}", new Object[]{earTag}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
