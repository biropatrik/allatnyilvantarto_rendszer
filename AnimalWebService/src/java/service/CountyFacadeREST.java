...
public class CountyFacadeREST extends AbstractFacade<County> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, County entity) {
        super.edit(entity);
    }
    ...
    public County find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<County> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
